function [ muscleStrokes ] = chunkWS2(muscle,wingTime, upBound, lowBound, a )
...
% upBound - upper bound from chunkWS
% lowBound - lower bound from chunkWS

% This code distributed under GNU GPL license

%muscleStrokes = []; %use for initial compilation of M, then input dimensions into function 
 muscleStrokes = NaN(length(wingTime) + 1,a);

for k = 1:length(wingTime)
    n = 1;
